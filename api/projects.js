export default function handler(req, res) {
  ...
  try {
    // For Vercel deployments, we need the deployment URL
    // Locally, these will be served from the public directory
    ...
    const projects = [
      {
        ...
        // Using a direct path that works in all environments
